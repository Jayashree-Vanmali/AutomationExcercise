...
WebDriver driver;
	...
	public void category() throws IOException {
		...
		File dest= new File("C:\\Users\\x8hsbp\\Documents\\automationExcercise1\\src\\screenshot2.png");
	...
	public void brands() throws IOException {
		...
		File dest= new File("C:\\\\Users\\\\x8hsbp\\\\Documents\\\\automationExcercise1\\\\src\\\\screenshot3.png");
		FileHandler.copy(src, dest);
		System.out.println("Screenshot taken");
		madame.click();
		String title= driver.getTitle();
