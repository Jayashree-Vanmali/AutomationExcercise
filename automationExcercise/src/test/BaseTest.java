...
public class BaseTest {
	...
	public void signUp() throws Exception {
		...
		s.registerUser();
		s.newUser();
		s.credentials("Jayashree Vanmali", "jgrtvnml@gmail.com");
		s.birthdetails();
		s.addressdetails();
		s.accountCreated();
	}
	...
	public void login() {
		...
		l.validCredentials("jgrtvnml@gmail.com", "123456");
		l.invalidCredentials("jgrtvnml2@gmail.com", "123");
	}
	
	@Test(priority=4)
	public void registerwithexistingemail() throws Exception{
		RegisterWithExistingEmail reg=new RegisterWithExistingEmail(driver);
		reg.registerExistingEmail("Jayashree Vanmali", "jgrtvnml@gmail.com");
	...
	public void contactUsform() {
		...
		contact.contactUsForm("Jayashree","jgrtvnml@gmail.com", "delete account","unable to delete account");
	}
